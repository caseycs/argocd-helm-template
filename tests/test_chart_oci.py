"""Tests for OCI chart download scenario."""
...
def test_oci_chart_download_flow(tmp_path):
    """Test complete OCI chart download flow.
    ...
    assert repo_url == "public.ecr.aws/karpenter"
    assert chart_name == "karpenter"
